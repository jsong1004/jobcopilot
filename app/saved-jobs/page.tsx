  ...
  const handleParseJobUrl = async () => {
    ...
    try {
      ...
      if (job) {
        ...
        if (job.location) setNewJobLocation(job.location)
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex gap-2">
                      <Input 
                        ...
                        onBlur={() => newJobApplyUrl && handleParseJobUrl()}
                        disabled={isAddingJob || isParsingJobUrl} 
                      />
                      <Button type="button" variant="outline" onClick={handleParseJobUrl} disabled={!newJobApplyUrl || isParsingJobUrl}>
                        {isParsingJobUrl ? <Loader2 className="mr-2 h-4 w-4 animate-spin" /> : null}
                        {isParsingJobUrl ? 'Parsing' : 'Parse'}
                      </Button>
                    </div>
                    {parseMessage && (
                      <p
          ...
          {loading ? (
            ...
            <Card className="text-center py-12">
              <CardContent>
                ...
                <Button onClick={() => setIsAddJobDialogOpen(true)}>Add Job</Button>
              </CardContent>
            </Card>
