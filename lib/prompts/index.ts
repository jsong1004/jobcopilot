...
import { JOB_SCORING_PROMPTS, JOB_SUMMARY_PROMPTS, MULTI_AGENT_SCORING_PROMPTS, LANGGRAPH_OPTIMIZED_PROMPTS } from './job-matching'
...
Object.values(LANGGRAPH_OPTIMIZED_PROMPTS).forEach(prompt => promptManager.registerPrompt(prompt))
